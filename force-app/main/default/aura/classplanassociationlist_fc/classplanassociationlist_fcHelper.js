        ...
        if(!isDisabled){
             groupClassInformation.forEach(function(groupClassRecord){
                ...
                groupPlans.forEach(function(groupPlan){
                    allClassPlans.push({ 'Marketing_Plan__c': groupPlan.Id, 'Plan_Name__c': groupPlan.Plan_Name__c, 'Plan_Family__c': groupPlan.Plan_Family__c,'Marketing_Plan_Name__c': groupPlan.Name ,'Group_Class__c': groupClassRecord.Id, 'Effective_Date__c': quote.Effective_Date__c, 'Quote_Request__c': quote.Id});
                    selectedClassPlans.push({ 'Marketing_Plan__c': groupPlan.Id, 'Plan_Name__c': groupPlan.Plan_Name__c, 'Plan_Family__c': groupPlan.Plan_Family__c,'Marketing_Plan_Name__c': groupPlan.Name ,'Group_Class__c': groupClassRecord.Id, 'Effective_Date__c': quote.Effective_Date__c, 'Quote_Request__c': quote.Id});
                })
